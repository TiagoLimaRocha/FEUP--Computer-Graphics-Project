    ...
    if (typeof exports === "undefined") {
        ...
        f.rotate = function (t, i, r, n) {
            var s = n[0],
                ...
                l, u, h, d, f, p, v, m, _, g, b, x, y, E, w, A, T, C, M, S, R, F, k, B;
            if (Math.abs(c) < e) {
                return null
            }
            c = 1 / c;
...
! function (t, e) {
    ...
    function e(t, e) {
        ...
        return "CSS_RGB" === i ? "rgb(" + r + "," + n + "," + s + ")" : "CSS_RGBA" === i ? "rgba(" + r + "," + n + "," + s + "," + o + ")" : "HEX" === i ? "0x" + t.hex.toString(16) : "RGB_ARRAY" === i ? "[" + r + "," + n + "," + s + "]" : "RGBA_ARRAY" === i ? "[" + r + "," + n + "," + s + "," + o + "]" : "RGB_OBJ" === i ? "{r:" + r + ",g:" + n + ",b:" + s + "}" : "RGBA_OBJ" === i ? "{r:" + r + ",g:" + n + ",b:" + s + ",a:" + o + "}" : "HSV_OBJ" === i ? "{h:" + a + ",s:" + c + ",v:" + l + "}" : "HSVA_OBJ" === i ? "{h:" + a + ",s:" + c + ",v:" + l + ",a:" + o + "}" : "unknown format"
    }
    ...
    function c(t, e, i, r) {
        t.style.background = "", M.each(tt, function (n) {
    ...
    function f(t, e, i) {
        if (i.__li = e, i.__gui = t, M.extend(i, {
                options: function (e) {
            ...
            var r = new Q(i.object, i.property, {
                min: i.__min,
                max: i.__max,
                step: i.__step
            });
            ...
            }), j.addClass(e, "has-slider"), i.domElement.insertBefore(r.domElement, i.domElement.firstElementChild)
            ...
            i.min = M.compose(n, i.min), i.max = M.compose(n, i.max)
        } else i instanceof Y ? (j.bind(e, "click", function () {
            j.fakeEvent(i.__checkbox, "click")
        }), j.bind(i.__checkbox, "click", function (t) {
            t.stopPropagation()
        })) : i instanceof Z ? (j.bind(e, "click", function () {
        ...
        })) : i instanceof $ && (j.addClass(e, "color"), i.updateDisplay = M.compose(function (t) {
            return e.style.borderLeftColor = i.__color.toString(), t
        }, i.updateDisplay), i.updateDisplay());
        i.setValue = M.compose(function (e) {
    ...
    function v(t, e, i, r) {
        ...
        return j.addClass(c, ft.CLASS_CONTROLLER_ROW), n instanceof $ ? j.addClass(c, "color") : j.addClass(c, D(n.getValue())), f(t, c, n), t.__controllers.push(n), n
    }
    ...
    function b(t) {
        ...
        if (t.load && t.load.remembered ? M.each(t.load.remembered, function (e, i) {
                _(t, i, i === t.preset)
            }) : _(t, ot, !1), j.bind(o, "change", function () {
                for (var e = 0; e < t.__preset_select.length; e++) t.__preset_select[e].innerHTML = t.__preset_select[e].value;
                t.preset = this.value
            }), e.appendChild(o), e.appendChild(i), e.appendChild(r), e.appendChild(n), e.appendChild(s), at) {
            var a = document.getElementById("dg-local-explain"),
                c = document.getElementById("dg-local-storage");
            document.getElementById("dg-save-locally").style.display = "block", "true" === localStorage.getItem(m(t, "isLocal")) && c.setAttribute("checked", "checked"), g(t, a), j.bind(c, "change", function () {
    ...
    function x(t) {
        ...
        function r(r) {
            return r.preventDefault(), n = r.clientX, j.addClass(t.__closeButton, ft.CLASS_DRAG), j.bind(window, "mousemove", e), j.bind(window, "mouseup", i), !1
        }
        var n = void 0;
        t.__resize_handle = document.createElement("div"), M.extend(t.__resize_handle.style, {
            width: "6px",
            marginLeft: "-3px",
            height: "200px",
            cursor: "ew-resize",
            position: "absolute"
        }), j.bind(t.__resize_handle, "mousedown", r), j.bind(t.__closeButton, "mousedown", r), t.domElement.insertBefore(t.__resize_handle, t.domElement.firstElementChild)
    }
    ...
    function E(t, e) {
        var i = {};
        return M.each(t.__rememberedObjects, function (r, n) {
            var s = {},
    ...
    function A(t) {
        0 !== t.length && rt.call(window, function () {
            A(t)
        }), M.each(t, function (t) {
            t.updateDisplay()
        })
    ...
    var T = Array.prototype.forEach,
        ...
        M = {
            BREAK: {},
            extend: function (t) {
                return this.each(C.call(arguments, 1), function (e) {
            ...
            each: function (t, e, i) {
                if (t)
                    ...
                    for (var s in t)
                        if (e.call(i, t[s], s) === this.BREAK) return
            },
            defer: function (t) {
                setTimeout(t, 0)
            },
        ...
        S = [{
            ...
            conversions: {
                RGBA_OBJ: {
                    read: function (t) {
                        return !!(M.isNumber(t.r) && M.isNumber(t.g) && M.isNumber(t.b) && M.isNumber(t.a)) && {
                            space: "RGB",
                            r: t.r,
                            g: t.g,
                            b: t.b,
                ...
                RGB_OBJ: {
                    read: function (t) {
                        return !!(M.isNumber(t.r) && M.isNumber(t.g) && M.isNumber(t.b)) && {
                            space: "RGB",
                            r: t.r,
                            g: t.g,
                            b: t.b
                ...
                HSVA_OBJ: {
                    read: function (t) {
                        return !!(M.isNumber(t.h) && M.isNumber(t.s) && M.isNumber(t.v) && M.isNumber(t.a)) && {
                            space: "HSV",
                            h: t.h,
                            s: t.s,
                            v: t.v,
                ...
                HSV_OBJ: {
                    read: function (t) {
                        return !!(M.isNumber(t.h) && M.isNumber(t.s) && M.isNumber(t.v)) && {
                            space: "HSV",
                            h: t.h,
                            s: t.s,
                            v: t.v
        ...
        k = function () {
            ...
            return M.each(S, function (e) {
                if (e.litmus(t)) return M.each(e.conversions, function (e, i) {
        ...
        L = {
            ...
            rgb_to_hsv: function (t, e, i) {
                ...
                return 0 === n ? {
                    ...
                    s: 0,
                    v: 0
                } : (a = s / n, o = t === n ? (e - i) / s : e === n ? 2 + (i - t) / s : 4 + (t - e) / s, (o /= 6) < 0 && (o += 1), {
                    h: 360 * o,
                    s: a,
                    v: n / 255
                })
    ...
    I.recalculateRGB = function (t, e, i) {
        ...
        M.extend(t.__state, {
            s: e.s,
            v: e.v
        }), M.isNaN(e.h) ? M.isUndefined(t.__state.h) && (t.__state.h = 0) : t.__state.h = e.h
    }, I.COMPONENTS = ["r", "g", "b", "h", "s", "v", "hex", "a"], i(I.prototype, "r", 2), i(I.prototype, "g", 1), i(I.prototype, "b", 0), r(I.prototype, "h"), r(I.prototype, "s"), r(I.prototype, "v"), Object.defineProperty(I.prototype, "a", {
        get: function () {
    ...
    var N = function () {
            function t(e, i) {
                O(this, t), this.initialValue = e[i], this.domElement = document.createElement("div"), this.object = e, this.property = i, this.__onChange = void 0, this.__onFinishChange = void 0
            }
            return P(t, [{
                key: "onChange",
                value: function (t) {
    ...
    var H = /(\d+(\.\d+)?)px/,
        j = {
            ...
            makeFullscreen: function (t, e, i) {
                var r = i,
                    n = e;
                M.isUndefined(n) && (n = !0), M.isUndefined(r) && (r = !0), t.style.position = "absolute", n && (t.style.left = 0, t.style.right = 0), r && (t.style.top = 0, t.style.bottom = 0)
            },
                ...
                if (e)
                    if (t.className === e) t.removeAttribute("class");
                        ...
                        var i = t.className.split(/ +/),
                            r = i.indexOf(e); - 1 !== r && (i.splice(r, 1), t.className = i.join(" "))
                    }
        ...
        Y = function (t) {
            function e(t, i) {
                ...
                var r = G(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    n = r;
                return r.__prev = r.getValue(), r.__checkbox = document.createElement("input"), r.__checkbox.setAttribute("type", "checkbox"), j.bind(r.__checkbox, "change", function () {
                    n.setValue(!n.__prev)
            ...
            return V(e, N), P(e, [{
                ...
                key: "updateDisplay",
                value: function () {
                    return !0 === this.getValue() ? (this.__checkbox.setAttribute("checked", "checked"), this.__checkbox.checked = !0, this.__prev = !0) : (this.__checkbox.checked = !1, this.__prev = !1), U(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
                }
            }]), e
        }(),
        q = function (t) {
            function e(t, i, r) {
                ...
                return M.each(s, function (t, e) {
                    var i = document.createElement("option");
                    i.innerHTML = e, i.setAttribute("value", t), o.__select.appendChild(i)
                }), n.updateDisplay(), j.bind(n.__select, "change", function () {
            ...
            return V(e, N), P(e, [{
                ...
                key: "updateDisplay",
                value: function () {
                    return j.isActive(this.__select) ? this : (this.__select.value = this.getValue(), U(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this))
                }
            }]), e
        }(),
        W = function (t) {
            function e(t, i) {
                ...
                var n = G(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    s = n;
                return n.__input = document.createElement("input"), n.__input.setAttribute("type", "text"), j.bind(n.__input, "keyup", r), j.bind(n.__input, "change", r), j.bind(n.__input, "blur", function () {
            ...
            return V(e, N), P(e, [{
                key: "updateDisplay",
                value: function () {
                    return j.isActive(this.__input) || (this.__input.value = this.getValue()), U(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
                }
            }]), e
        }(),
        K = function (t) {
            function e(t, i, r) {
                ...
                var n = G(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    o = r || {};
                return n.__min = o.min, n.__max = o.max, n.__step = o.step, M.isUndefined(n.__step) ? 0 === n.initialValue ? n.__impliedStep = 1 : n.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(n.initialValue)) / Math.LN10)) / 10 : n.__impliedStep = n.__step, n.__precision = s(n.__impliedStep), n
            }
            return V(e, N), P(e, [{
                key: "setValue",
                value: function (t) {
                    var i = t;
                    return void 0 !== this.__min && i < this.__min ? i = this.__min : void 0 !== this.__max && i > this.__max && (i = this.__max), void 0 !== this.__step && i % this.__step != 0 && (i = Math.round(i / this.__step) * this.__step), U(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "setValue", this).call(this, i)
                }
            }, {
                key: "min",
                value: function (t) {
        ...
        Q = function (t) {
            function e(t, i, r) {
                ...
                var c = a,
                    l = void 0;
                return a.__input = document.createElement("input"), a.__input.setAttribute("type", "text"), j.bind(a.__input, "change", function () {
            ...
            return V(e, K), P(e, [{
                key: "updateDisplay",
                value: function () {
                    return this.__input.value = this.__truncationSuspended ? this.getValue() : o(this.getValue(), this.__precision), U(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
                }
            }]), e
        }(),
        J = function (t) {
            function e(t, i, r, n, s) {
                ...
                O(this, e);
                var h = G(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i, {
                        min: r,
                        max: n,
                        step: s
                    })),
                    d = h;
                return h.__background = document.createElement("div"), h.__foreground = document.createElement("div"), j.bind(h.__background, "mousedown", function (t) {
                ...
                }), j.addClass(h.__background, "slider"), j.addClass(h.__foreground, "slider-fg"), h.updateDisplay(), h.__background.appendChild(h.__foreground), h.domElement.appendChild(h.__background), h
            }
            return V(e, K), P(e, [{
                key: "updateDisplay",
                value: function () {
                    var t = (this.getValue() - this.__min) / (this.__max - this.__min);
                    return this.__foreground.style.width = 100 * t + "%", U(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
                }
            }]), e
        }(),
        Z = function (t) {
            function e(t, i, r) {
                ...
                var n = G(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    s = n;
                return n.__button = document.createElement("div"), n.__button.innerHTML = void 0 === r ? "Fire" : r, j.bind(n.__button, "click", function (t) {
                    return t.preventDefault(), s.fire(), !1
                }), j.addClass(n.__button, "button"), n.domElement.appendChild(n.__button), n
            }
            return V(e, N), P(e, [{
                key: "fire",
                value: function () {
        ...
        $ = function (t) {
            function e(t, i) {
                ...
                function h(t) {
                    ...
                    return o > 1 ? o = 1 : o < 0 && (o = 0), s > 1 ? s = 1 : s < 0 && (s = 0), p.__color.v = o, p.__color.s = s, p.setValue(p.__color.toOriginal()), !1
                }
                ...
                var p = f;
                f.domElement = document.createElement("div"), j.makeSelectable(f.domElement, !1), f.__selector = document.createElement("div"), f.__selector.className = "selector", f.__saturation_field = document.createElement("div"), f.__saturation_field.className = "saturation-field", f.__field_knob = document.createElement("div"), f.__field_knob.className = "field-knob", f.__field_knob_border = "2px solid ", f.__hue_knob = document.createElement("div"), f.__hue_knob.className = "hue-knob", f.__hue_field = document.createElement("div"), f.__hue_field.className = "hue-field", f.__input = document.createElement("input"), f.__input.type = "text", f.__input_textShadow = "0 1px 1px ", j.bind(f.__input, "keydown", function (t) {
                    13 === t.keyCode && a.call(this)
                }), j.bind(f.__input, "blur", a), j.bind(f.__selector, "mousedown", function () {
                ...
                return M.extend(f.__selector.style, {
                    width: "122px",
                    height: "102px",
                    padding: "3px",
                    backgroundColor: "#222",
                    ...
                    width: "12px",
                    height: "12px",
                    border: f.__field_knob_border + (f.__color.v < .5 ? "#fff" : "#000"),
                    boxShadow: "0px 1px 3px rgba(0,0,0,0.5)",
                    borderRadius: "12px",
                    zIndex: 1
                }), M.extend(f.__hue_knob.style, {
                    position: "absolute",
                    width: "15px",
                    height: "2px",
                    ...
                    height: "100%",
                    background: "none"
                }), c(v, "top", "rgba(0,0,0,0)", "#000"), M.extend(f.__hue_field.style, {
                    width: "15px",
                    height: "100px",
                    border: "1px solid #555",
                    cursor: "ns-resize",
                    ...
                    top: "3px",
                    right: "3px"
                }), l(f.__hue_field), M.extend(f.__input.style, {
                    outline: "none",
                    textAlign: "center",
                    color: "#fff",
                    border: 0,
                ...
                }), j.bind(f.__saturation_field, "mousedown", r), j.bind(f.__saturation_field, "touchstart", r), j.bind(f.__field_knob, "mousedown", r), j.bind(f.__field_knob, "touchstart", r), j.bind(f.__hue_field, "mousedown", n), j.bind(f.__hue_field, "touchstart", n), f.__saturation_field.appendChild(v), f.__selector.appendChild(f.__field_knob), f.__selector.appendChild(f.__saturation_field), f.__selector.appendChild(f.__hue_field), f.__hue_field.appendChild(f.__hue_knob), f.domElement.appendChild(f.__input), f.domElement.appendChild(f.__selector), f.updateDisplay(), f
            }
            return V(e, N), P(e, [{
                key: "updateDisplay",
                value: function () {
                    ...
                    if (!1 !== t) {
                        var e = !1;
                        M.each(I.COMPONENTS, function (i) {
                            if (!M.isUndefined(t[i]) && !M.isUndefined(this.__color.__state[i]) && t[i] !== this.__color.__state[i]) return e = !0, {}
                        }, this), e && M.extend(this.__color.__state, t)
                    }
                    ...
                    }), this.__hue_knob.style.marginTop = 100 * (1 - this.__color.h / 360) + "px", this.__temp.s = 1, this.__temp.v = 1, c(this.__saturation_field, "left", "#fff", this.__temp.toHexString()), this.__input.value = this.__color.toString(), M.extend(this.__input.style, {
        ...
        it = function (t, e) {
            var i = t[e];
            return M.isArray(arguments[2]) || M.isObject(arguments[2]) ? new q(t, e, arguments[2]) : M.isNumber(i) ? M.isNumber(arguments[2]) && M.isNumber(arguments[3]) ? M.isNumber(arguments[4]) ? new J(t, e, arguments[2], arguments[3], arguments[4]) : new J(t, e, arguments[2], arguments[3]) : M.isNumber(arguments[4]) ? new Q(t, e, {
                min: arguments[2],
                max: arguments[3],
                step: arguments[4]
            }) : new Q(t, e, {
                min: arguments[2],
                max: arguments[3]
            }) : M.isString(i) ? new W(t, e) : M.isFunction(i) ? new Z(t, e, "") : M.isBoolean(i) ? new Y(t, e) : null
        },
        rt = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
            setTimeout(t, 1e3 / 60)
        },
        nt = function () {
            function t() {
                O(this, t), this.backgroundElement = document.createElement("div"), M.extend(this.backgroundElement.style, {
                ...
                }), j.makeFullscreen(this.backgroundElement), this.backgroundElement.style.position = "fixed", this.domElement = document.createElement("div"), M.extend(this.domElement.style, {
                    position: "fixed",
                    display: "none",
                    zIndex: "1001",
                    opacity: 0,
            ...
            return P(t, [{
                ...
                value: function () {
                    var t = this,
                        e = function e() {
                            t.domElement.style.display = "none", t.backgroundElement.style.display = "none", j.unbind(t.domElement, "webkitTransitionEnd", e), j.unbind(t.domElement, "transitionend", e), j.unbind(t.domElement, "oTransitionEnd", e)
                        };
                    j.bind(this.domElement, "webkitTransitionEnd", e), j.bind(this.domElement, "transitionend", e), j.bind(this.domElement, "oTransitionEnd", e), this.backgroundElement.style.opacity = 0, this.domElement.style.opacity = 0, this.domElement.style.webkitTransform = "scale(1.1)"
                }
            }, {
                key: "layout",
                value: function () {
                    this.domElement.style.left = window.innerWidth / 2 - j.getWidth(this.domElement) / 2 + "px", this.domElement.style.top = window.innerHeight / 2 - j.getHeight(this.domElement) / 2 + "px"
                }
            }]), t
        }(),
        st = function (t) {
    ...
    var ot = "Default",
        ...
        ft = function t(e) {
            var i = this,
                r = e || {};
            this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), j.addClass(this.domElement, "dg"), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], r = M.defaults(r, {
                closeOnTop: !1,
                autoPlace: !0,
            ...
            }), M.isUndefined(r.load) ? r.load = {
                preset: ot
            } : r.preset && (r.load.preset = r.preset), M.isUndefined(r.parent) && r.hideable && dt.push(this), r.resizable = M.isUndefined(r.parent) && r.resizable, r.autoPlace && M.isUndefined(r.scrollable) && (r.scrollable = !0);
            ...
            if (Object.defineProperties(this, {
                    ...
                    closed: {
                        ...
                        set: function (e) {
                            r.closed = e, r.closed ? j.addClass(i.__ul, t.CLASS_CLOSED) : j.removeClass(i.__ul, t.CLASS_CLOSED), this.onResize(), i.__closeButton && (i.__closeButton.innerHTML = e ? t.TEXT_OPEN : t.TEXT_CLOSED)
                        }
                    },
                    load: {
                        get: function () {
                ...
                this.__closeButton = document.createElement("div"), this.__closeButton.innerHTML = t.TEXT_CLOSED, j.addClass(this.__closeButton, t.CLASS_CLOSE_BUTTON), r.closeOnTop ? (j.addClass(this.__closeButton, t.CLASS_CLOSE_TOP), this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0])) : (j.addClass(this.__closeButton, t.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)), j.bind(this.__closeButton, "click", function () {
                    i.closed = !i.closed
                })
            } else {
                ...
                j.addClass(this.__ul, t.CLASS_CLOSED), j.addClass(o, "title"), j.bind(o, "click", function (t) {
                    return t.preventDefault(), i.closed = !i.closed, !1
                }), r.closed || (this.closed = !1)
            }
            r.autoPlace && (M.isUndefined(r.parent) && (lt && (ut = document.createElement("div"), j.addClass(ut, "dg"), j.addClass(ut, t.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(ut), lt = !1), ut.appendChild(this.domElement), j.addClass(this.domElement, t.CLASS_AUTO_PLACE)), this.parent || y(i, r.width)), this.__resizeHandler = function () {
                i.onResizeDebounced()
            }, j.bind(window, "resize", this.__resizeHandler), j.bind(this.__ul, "webkitTransitionEnd", this.__resizeHandler), j.bind(this.__ul, "transitionend", this.__resizeHandler), j.bind(this.__ul, "oTransitionEnd", this.__resizeHandler), this.onResize(), r.resizable && x(this), s = function () {
                at && "true" === localStorage.getItem(m(i, "isLocal")) && localStorage.setItem(m(i, "gui"), JSON.stringify(i.getSaveObject()))
            }, this.saveToLocalStorageIfPossible = s, r.parent || function () {
                var t = i.getRoot();
                t.width += 1, M.defer(function () {
                    t.width -= 1
                })
            }()
        };
    ft.toggleHide = function () {
        ht = !ht, M.each(dt, function (t) {
            t.domElement.style.display = ht ? "none" : ""
        })
    }, ft.CLASS_AUTO_PLACE = "a", ft.CLASS_AUTO_PLACE_CONTAINER = "ac", ft.CLASS_MAIN = "main", ft.CLASS_CONTROLLER_ROW = "cr", ft.CLASS_TOO_TALL = "taller-than-window", ft.CLASS_CLOSED = "closed", ft.CLASS_CLOSE_BUTTON = "close-button", ft.CLASS_CLOSE_TOP = "close-top", ft.CLASS_CLOSE_BOTTOM = "close-bottom", ft.CLASS_DRAG = "drag", ft.DEFAULT_WIDTH = 245, ft.TEXT_CLOSED = "Close Controls", ft.TEXT_OPEN = "Open Controls", ft._keydownHandler = function (t) {
        "text" === document.activeElement.type || 72 !== t.which && 72 !== t.keyCode || ft.toggleHide()
    }, j.bind(window, "keydown", ft._keydownHandler, !1), M.extend(ft.prototype, {
        add: function (t, e) {
            return v(this, t, e, {
        ...
        destroy: function () {
            ...
            M.each(this.__folders, function (e) {
                t.removeFolder(e)
            }), j.unbind(window, "keydown", ft._keydownHandler, !1), h(this)
        },
        ...
        onResize: function () {
            ...
            if (t.scrollable) {
                ...
                }), window.innerHeight - e - 20 < i ? (j.addClass(t.domElement, ft.CLASS_TOO_TALL), t.__ul.style.height = window.innerHeight - e - 20 + "px") : (j.removeClass(t.domElement, ft.CLASS_TOO_TALL), t.__ul.style.height = "auto")
            }
            t.__resize_handle && M.defer(function () {
        ...
        getSaveObject: function () {
            var t = this.load;
            return t.closed = this.closed, this.__rememberedObjects.length > 0 && (t.preset = this.preset, t.remembered || (t.remembered = {}), t.remembered[this.preset] = E(this)), t.folders = {}, M.each(this.__folders, function (e, i) {
                t.folders[i] = e.getSaveObject()
            }), t
        },
        save: function () {
            this.load.remembered || (this.load.remembered = {}), this.load.remembered[this.preset] = E(this), d(this, !1), this.saveToLocalStorageIfPossible()
        },
        saveAs: function (t) {
            this.load.remembered || (this.load.remembered = {}, this.load.remembered[ot] = E(this, !0)), this.load.remembered[t] = E(this), this.preset = t, _(this, t, !0), this.saveToLocalStorageIfPossible()
        },
        revert: function (t) {
            ...
            }, this), M.each(this.__folders, function (t) {
                t.revert(t)
            }), t || d(this.getRoot(), !1)
        },
        listen: function (t) {
...
class CGFtexture {
    constructor(t, e) {
        ...
        this.image.onload = function () {
            ...
            i.gl.texParameteri(i.gl.TEXTURE_2D, i.gl.TEXTURE_MAG_FILTER, i.gl.NEAREST_MIPMAP_LINEAR);
            if (isPowerOfTwo(i.image.width) && isPowerOfTwo(i.image.height)) {
                i.gl.texParameteri(i.gl.TEXTURE_2D, i.gl.TEXTURE_MIN_FILTER, i.gl.NEAREST_MIPMAP_LINEAR)
            } else {
                i.gl.texParameteri(i.gl.TEXTURE_2D, i.gl.TEXTURE_MIN_FILTER, i.gl.NEAREST_MIPMAP_LINEAR);
